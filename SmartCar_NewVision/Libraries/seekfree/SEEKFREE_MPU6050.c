...
void InitMPU6050(void)
{
    ...
    simiic_write_reg(MPU6050_DEV_ADDR, SMPLRT_DIV, 0x00);      //125HZ采样率//0x07
    simiic_write_reg(MPU6050_DEV_ADDR, CONFIG, 0x00);          //
    simiic_write_reg(MPU6050_DEV_ADDR, GYRO_CONFIG, 0x18);   //0x18  //2000
    simiic_write_reg(MPU6050_DEV_ADDR, ACCEL_CONFIG, 0x01);    //8g//0x10
