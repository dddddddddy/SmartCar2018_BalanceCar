...
#define NRF_DATA_WIDTH  5                  // RF数据宽度 1~32byte


//-------宏定义引脚--------
#define NRF_CE_PIN          D6
#define NRF_CSN_PIN         B5
#define NRF_MOSI_PIN        B3
#define NRF_SCK_PIN         B2
                            
#define NRF_MISO_PIN        B4
#define NRF_IRQ_PIN         D7
